...
gulp.task('server:dev', function() {
  ...
  browserSync.init({
    ...
    // https://stackoverflow.com/questions/27579007/how-to-temporarily-disable-browsersync/44731009#44731009
    snippetOptions: {
    	  rule: {
    	    match: /qqqqqqqqq/
    	  }
...
gulp.task('server:dist', function() {
  ...
  browserSync.init({
    ...
    // https://stackoverflow.com/questions/27579007/how-to-temporarily-disable-browsersync/44731009#44731009
    // comment these out, if you want to disable the reload by BrowserSync
    // uncomment theset uot, if you want to enable the reload by BrowserSync
